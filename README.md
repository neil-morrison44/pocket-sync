...
Starting with v5.3.0 the app should be notarised with Apple, meaning that they've checked it for malware etc & now there should just be a single dismissable warning about downloading an app from the internet.

So long as the Github sponsors stay above the cost of an Apple Dev Membership I'll keep the app notarised.
